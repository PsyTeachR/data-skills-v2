...
<div class='webex-radiogroup' id='radio_FHNFDRCRQR'><label><input type="radio" autocomplete="off" name="radio_FHNFDRCRQR" value=""></input> <span>The tendency to be organized, careful, and disciplined</span></label><label><input type="radio" autocomplete="off" name="radio_FHNFDRCRQR" value="answer"></input> <span>The tendency to be compassionate, cooperative, and warm towards others</span></label><label><input type="radio" autocomplete="off" name="radio_FHNFDRCRQR" value=""></input> <span>The tendency to be outgoing, energetic, and sociable</span></label><label><input type="radio" autocomplete="off" name="radio_FHNFDRCRQR" value=""></input> <span>The tendency to experience mood swings, anxiety, and irritability.</span></label></div>
...
<div class='webex-radiogroup' id='radio_XGDYFUQRRN'><label><input type="radio" autocomplete="off" name="radio_XGDYFUQRRN" value=""></input> <span>Neuroticism</span></label><label><input type="radio" autocomplete="off" name="radio_XGDYFUQRRN" value="answer"></input> <span>Conscientiousness</span></label><label><input type="radio" autocomplete="off" name="radio_XGDYFUQRRN" value=""></input> <span>Extraversion</span></label><label><input type="radio" autocomplete="off" name="radio_XGDYFUQRRN" value=""></input> <span>Agreeableness</span></label></div>
...
<div class='webex-radiogroup' id='radio_AUKNYAKFTX'><label><input type="radio" autocomplete="off" name="radio_AUKNYAKFTX" value=""></input> <span>Extraversion</span></label><label><input type="radio" autocomplete="off" name="radio_AUKNYAKFTX" value=""></input> <span>Conscientiousness</span></label><label><input type="radio" autocomplete="off" name="radio_AUKNYAKFTX" value=""></input> <span>Neuroticism</span></label><label><input type="radio" autocomplete="off" name="radio_AUKNYAKFTX" value="answer"></input> <span>Openness to Experience</span></label></div>
