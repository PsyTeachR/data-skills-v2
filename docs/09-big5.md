...
<div class='webex-radiogroup' id='radio_CAGMYOUYQU'><label><input type="radio" autocomplete="off" name="radio_CAGMYOUYQU" value=""></input> <span>Neuroticism</span></label><label><input type="radio" autocomplete="off" name="radio_CAGMYOUYQU" value="answer"></input> <span>Conscientiousness</span></label><label><input type="radio" autocomplete="off" name="radio_CAGMYOUYQU" value=""></input> <span>Extraversion</span></label><label><input type="radio" autocomplete="off" name="radio_CAGMYOUYQU" value=""></input> <span>Agreeableness</span></label></div>
...
<div class='webex-radiogroup' id='radio_RHDXCKLFVY'><label><input type="radio" autocomplete="off" name="radio_RHDXCKLFVY" value=""></input> <span>Extraversion</span></label><label><input type="radio" autocomplete="off" name="radio_RHDXCKLFVY" value=""></input> <span>Conscientiousness</span></label><label><input type="radio" autocomplete="off" name="radio_RHDXCKLFVY" value=""></input> <span>Neuroticism</span></label><label><input type="radio" autocomplete="off" name="radio_RHDXCKLFVY" value="answer"></input> <span>Openness to Experience</span></label></div>
