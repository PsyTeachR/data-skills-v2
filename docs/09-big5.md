...
<div class='webex-radiogroup' id='radio_VXODLCXYUK'><label><input type="radio" autocomplete="off" name="radio_VXODLCXYUK" value=""></input> <span>The tendency to be organized, careful, and disciplined</span></label><label><input type="radio" autocomplete="off" name="radio_VXODLCXYUK" value="answer"></input> <span>The tendency to be compassionate, cooperative, and warm towards others</span></label><label><input type="radio" autocomplete="off" name="radio_VXODLCXYUK" value=""></input> <span>The tendency to be outgoing, energetic, and sociable</span></label><label><input type="radio" autocomplete="off" name="radio_VXODLCXYUK" value=""></input> <span>The tendency to experience mood swings, anxiety, and irritability.</span></label></div>
...
<div class='webex-radiogroup' id='radio_OPHGHWNDJK'><label><input type="radio" autocomplete="off" name="radio_OPHGHWNDJK" value=""></input> <span>Neuroticism</span></label><label><input type="radio" autocomplete="off" name="radio_OPHGHWNDJK" value="answer"></input> <span>Conscientiousness</span></label><label><input type="radio" autocomplete="off" name="radio_OPHGHWNDJK" value=""></input> <span>Extraversion</span></label><label><input type="radio" autocomplete="off" name="radio_OPHGHWNDJK" value=""></input> <span>Agreeableness</span></label></div>
...
<div class='webex-radiogroup' id='radio_SHRPCARATI'><label><input type="radio" autocomplete="off" name="radio_SHRPCARATI" value=""></input> <span>Extraversion</span></label><label><input type="radio" autocomplete="off" name="radio_SHRPCARATI" value=""></input> <span>Conscientiousness</span></label><label><input type="radio" autocomplete="off" name="radio_SHRPCARATI" value=""></input> <span>Neuroticism</span></label><label><input type="radio" autocomplete="off" name="radio_SHRPCARATI" value="answer"></input> <span>Openness to Experience</span></label></div>
