...
<div class='webex-radiogroup' id='radio_WSSOLUVFRJ'><label><input type="radio" autocomplete="off" name="radio_WSSOLUVFRJ" value=""></input> <span>Neuroticism</span></label><label><input type="radio" autocomplete="off" name="radio_WSSOLUVFRJ" value="answer"></input> <span>Conscientiousness</span></label><label><input type="radio" autocomplete="off" name="radio_WSSOLUVFRJ" value=""></input> <span>Extraversion</span></label><label><input type="radio" autocomplete="off" name="radio_WSSOLUVFRJ" value=""></input> <span>Agreeableness</span></label></div>
...
<div class='webex-radiogroup' id='radio_MGEKZKXSOP'><label><input type="radio" autocomplete="off" name="radio_MGEKZKXSOP" value=""></input> <span>Extraversion</span></label><label><input type="radio" autocomplete="off" name="radio_MGEKZKXSOP" value=""></input> <span>Conscientiousness</span></label><label><input type="radio" autocomplete="off" name="radio_MGEKZKXSOP" value=""></input> <span>Neuroticism</span></label><label><input type="radio" autocomplete="off" name="radio_MGEKZKXSOP" value="answer"></input> <span>Openness to Experience</span></label></div>
