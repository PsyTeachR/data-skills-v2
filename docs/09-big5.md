...
<div class='webex-radiogroup' id='radio_KGVFTJSDAO'><label><input type="radio" autocomplete="off" name="radio_KGVFTJSDAO" value=""></input> <span>The tendency to be organized, careful, and disciplined</span></label><label><input type="radio" autocomplete="off" name="radio_KGVFTJSDAO" value="answer"></input> <span>The tendency to be compassionate, cooperative, and warm towards others</span></label><label><input type="radio" autocomplete="off" name="radio_KGVFTJSDAO" value=""></input> <span>The tendency to be outgoing, energetic, and sociable</span></label><label><input type="radio" autocomplete="off" name="radio_KGVFTJSDAO" value=""></input> <span>The tendency to experience mood swings, anxiety, and irritability.</span></label></div>
...
<div class='webex-radiogroup' id='radio_MWBWNSWFEQ'><label><input type="radio" autocomplete="off" name="radio_MWBWNSWFEQ" value=""></input> <span>Neuroticism</span></label><label><input type="radio" autocomplete="off" name="radio_MWBWNSWFEQ" value="answer"></input> <span>Conscientiousness</span></label><label><input type="radio" autocomplete="off" name="radio_MWBWNSWFEQ" value=""></input> <span>Extraversion</span></label><label><input type="radio" autocomplete="off" name="radio_MWBWNSWFEQ" value=""></input> <span>Agreeableness</span></label></div>
...
<div class='webex-radiogroup' id='radio_UAVUFSUDFQ'><label><input type="radio" autocomplete="off" name="radio_UAVUFSUDFQ" value=""></input> <span>Extraversion</span></label><label><input type="radio" autocomplete="off" name="radio_UAVUFSUDFQ" value=""></input> <span>Conscientiousness</span></label><label><input type="radio" autocomplete="off" name="radio_UAVUFSUDFQ" value=""></input> <span>Neuroticism</span></label><label><input type="radio" autocomplete="off" name="radio_UAVUFSUDFQ" value="answer"></input> <span>Openness to Experience</span></label></div>
