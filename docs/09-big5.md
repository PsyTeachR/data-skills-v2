...
<div class='webex-radiogroup' id='radio_PFIXGWMMYO'><label><input type="radio" autocomplete="off" name="radio_PFIXGWMMYO" value=""></input> <span>Neuroticism</span></label><label><input type="radio" autocomplete="off" name="radio_PFIXGWMMYO" value="answer"></input> <span>Conscientiousness</span></label><label><input type="radio" autocomplete="off" name="radio_PFIXGWMMYO" value=""></input> <span>Extraversion</span></label><label><input type="radio" autocomplete="off" name="radio_PFIXGWMMYO" value=""></input> <span>Agreeableness</span></label></div>
...
<div class='webex-radiogroup' id='radio_UBXCFJCYYB'><label><input type="radio" autocomplete="off" name="radio_UBXCFJCYYB" value=""></input> <span>Extraversion</span></label><label><input type="radio" autocomplete="off" name="radio_UBXCFJCYYB" value=""></input> <span>Conscientiousness</span></label><label><input type="radio" autocomplete="off" name="radio_UBXCFJCYYB" value=""></input> <span>Neuroticism</span></label><label><input type="radio" autocomplete="off" name="radio_UBXCFJCYYB" value="answer"></input> <span>Openness to Experience</span></label></div>
