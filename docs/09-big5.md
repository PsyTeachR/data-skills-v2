...
<div class='webex-radiogroup' id='radio_BKYSILTKLZ'><label><input type="radio" autocomplete="off" name="radio_BKYSILTKLZ" value=""></input> <span>Neuroticism</span></label><label><input type="radio" autocomplete="off" name="radio_BKYSILTKLZ" value="answer"></input> <span>Conscientiousness</span></label><label><input type="radio" autocomplete="off" name="radio_BKYSILTKLZ" value=""></input> <span>Extraversion</span></label><label><input type="radio" autocomplete="off" name="radio_BKYSILTKLZ" value=""></input> <span>Agreeableness</span></label></div>
...
<div class='webex-radiogroup' id='radio_EMCQAOHJTW'><label><input type="radio" autocomplete="off" name="radio_EMCQAOHJTW" value=""></input> <span>Extraversion</span></label><label><input type="radio" autocomplete="off" name="radio_EMCQAOHJTW" value=""></input> <span>Conscientiousness</span></label><label><input type="radio" autocomplete="off" name="radio_EMCQAOHJTW" value=""></input> <span>Neuroticism</span></label><label><input type="radio" autocomplete="off" name="radio_EMCQAOHJTW" value="answer"></input> <span>Openness to Experience</span></label></div>
