...
<div class='webex-radiogroup' id='radio_VKWHVOKYAH'><label><input type="radio" autocomplete="off" name="radio_VKWHVOKYAH" value=""></input> <span>Neuroticism</span></label><label><input type="radio" autocomplete="off" name="radio_VKWHVOKYAH" value="answer"></input> <span>Conscientiousness</span></label><label><input type="radio" autocomplete="off" name="radio_VKWHVOKYAH" value=""></input> <span>Extraversion</span></label><label><input type="radio" autocomplete="off" name="radio_VKWHVOKYAH" value=""></input> <span>Agreeableness</span></label></div>
...
<div class='webex-radiogroup' id='radio_JAHECKLMCK'><label><input type="radio" autocomplete="off" name="radio_JAHECKLMCK" value=""></input> <span>Extraversion</span></label><label><input type="radio" autocomplete="off" name="radio_JAHECKLMCK" value=""></input> <span>Conscientiousness</span></label><label><input type="radio" autocomplete="off" name="radio_JAHECKLMCK" value=""></input> <span>Neuroticism</span></label><label><input type="radio" autocomplete="off" name="radio_JAHECKLMCK" value="answer"></input> <span>Openness to Experience</span></label></div>
