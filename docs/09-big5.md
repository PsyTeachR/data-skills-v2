...
<div class='webex-radiogroup' id='radio_MKKVWAWZBN'><label><input type="radio" autocomplete="off" name="radio_MKKVWAWZBN" value=""></input> <span>The tendency to be organized, careful, and disciplined</span></label><label><input type="radio" autocomplete="off" name="radio_MKKVWAWZBN" value="answer"></input> <span>The tendency to be compassionate, cooperative, and warm towards others</span></label><label><input type="radio" autocomplete="off" name="radio_MKKVWAWZBN" value=""></input> <span>The tendency to be outgoing, energetic, and sociable</span></label><label><input type="radio" autocomplete="off" name="radio_MKKVWAWZBN" value=""></input> <span>The tendency to experience mood swings, anxiety, and irritability.</span></label></div>
...
<div class='webex-radiogroup' id='radio_FWTQDUPDII'><label><input type="radio" autocomplete="off" name="radio_FWTQDUPDII" value=""></input> <span>Neuroticism</span></label><label><input type="radio" autocomplete="off" name="radio_FWTQDUPDII" value="answer"></input> <span>Conscientiousness</span></label><label><input type="radio" autocomplete="off" name="radio_FWTQDUPDII" value=""></input> <span>Extraversion</span></label><label><input type="radio" autocomplete="off" name="radio_FWTQDUPDII" value=""></input> <span>Agreeableness</span></label></div>
...
<div class='webex-radiogroup' id='radio_BUSUBKAQEP'><label><input type="radio" autocomplete="off" name="radio_BUSUBKAQEP" value=""></input> <span>Extraversion</span></label><label><input type="radio" autocomplete="off" name="radio_BUSUBKAQEP" value=""></input> <span>Conscientiousness</span></label><label><input type="radio" autocomplete="off" name="radio_BUSUBKAQEP" value=""></input> <span>Neuroticism</span></label><label><input type="radio" autocomplete="off" name="radio_BUSUBKAQEP" value="answer"></input> <span>Openness to Experience</span></label></div>
